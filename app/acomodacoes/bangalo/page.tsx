...
const roomDetails = {
    title: "Bangalô da Serra",
    subtitle: "O refúgio perfeito para casais, unindo rusticidade e sofisticação.",
    description: "Desenhado para proporcionar momentos inesquecíveis, o nosso Bangalô oferece uma experiência de imersão total na natureza sem abrir mão do conforto contemporâneo. Com uma varanda privativa voltada para o vale, você poderá desfrutar do pôr do sol imerso em natureza e silêncio. O ambiente interno conta com decoração minimalista, iluminação aconchegante e enxoval de alto padrão para garantir o seu descanso absoluto.",
    price: "R$ 850",
    amenities: [
