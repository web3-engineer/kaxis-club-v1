...
const roomDetails = {
    title: "Chalé Family",
    subtitle: "O refúgio perfeito para familias, unindo conforto, espaço e natureza.",
    description: "Desenhado para proporcionar momentos inesquecíveis para sua familia, o nosso Chalé Family oferece uma experiência de imersão total na natureza sem abrir mão do conforto contemporâneo. Com uma varanda privativa voltada para o vale, você poderá desfrutar do pôr do sol imerso em uma jacuzzi exclusiva e aquecida. O ambiente interno conta com decoração minimalista, iluminação aconchegante e enxoval de alto padrão para garantir o seu descanso absoluto.",
    price: "R$ 850",
    amenities: [
